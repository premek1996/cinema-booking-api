...
public class CinemaHallController {
    ...
    @PutMapping("/{id}")
    CinemaHallResponse updateCinemaHall(@PathVariable Long id, @RequestBody @Valid UpdateCinemaHallRequest updateCinemaHallRequest) {
        return cinemaHallService.updateCinemaHall(id, updateCinemaHallRequest);
    }
